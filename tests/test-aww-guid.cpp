...
public:
  std::function<bool(const std::string &)>
      clipboard_set_text_stub = [this]([[maybe_unused]] const std::string &text) -> bool
  {
  ...
  std::function<aww::Result(std::string &)>
      os_get_guid_stub = [this]([[maybe_unused]] std::string &out) -> aww::Result
  {
    out = DEFAULT_GUID;
...
{
    aww_guid_io_dependencies_stub deps;
    deps.os_get_guid_stub = []([[maybe_unused]] std::string &out) -> aww::Result {
...
{
    aww_guid_io_dependencies_stub deps;
    deps.clipboard_set_text_stub = []([[maybe_unused]] const std::string &text) -> bool {
