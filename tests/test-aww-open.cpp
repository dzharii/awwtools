...
class aww_open_io_dependencies_stub
    : public aww::internal::aww_open::aww_open_io_dependencies_interface {
public:
  std::function<aww::Result(const std::string&)> launch_file_stub =
      [this](const std::string& filePath) -> aww::Result {
